...
| Vulnerability | What it means in plain language |
|---|---|
...
SAST tools rank findings by severity, usually using **CVSS (Common Vulnerability Scoring System)**:
...
> **Tip:** Match the tool to the language of your codebase. If your project is in Python, Bandit or Semgrep is a quick win. If it's in JavaScript, try Snyk Code or Semgrep.
...
## 8. Grading Rubric (Total: 100 marks)

| Criterion | Marks |
|---|---|
| Tool installed and scan executed correctly (with evidence) | 15 |
| Scan output presented clearly with severity breakdown | 15 |
| Three critical findings identified and clearly described | 25 |
| Quality of false-positive justification | 20 |
| Suggested fixes are technically reasonable | 10 |
| Report is well-structured, professional, and uses correct terminology | 10 |
| Reflection shows understanding of where SAST fits in enterprise practice | 5 |
